    ...
    content: [
      ...
      },
      {
        ...
        description: `
          ...
          before typeahead kicks-in. In example a typeahead appears with delay in 1 second</p>
        `,
      ...
      },
      {
        ...
        anchor: 'on-select',
        description: `
          <p>Output <code>typeaheadOnSelect</code> is fired when an option was selected.
